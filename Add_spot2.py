...
def main(WindowName, image, pixel_per_cm, hl, sl, vl, hu, su, vu):
    ...
    while True:
        ...
        if not clicked and start_point and end_point:
            ...
            if contours==():
                #max_contour = [[[start_point[0]+1, start_point[1]+1]], [[end_point[0]-1, start_point[1]+1]],[[end_point[0]-1, start_point[1]-1]],[[start_point[0]+1, end_point[1]-1]]]
                #max_contour = [[[[1, 1]], [[end_point[0]-start_point[0]-1, 1]],[[end_point[0]-start_point[0]-1, end_point[1]-start_point[1]-1]],[[1, end_point[1]-start_point[1]-1]]]]
                max_contour = np.array([[[1, 1]], [[end_point[0]-start_point[0]-1, 1]],[[end_point[0]-start_point[0]-1, end_point[1]-start_point[1]-1]],[[1, end_point[1]-start_point[1]-1]]], dtype=np.int32)
